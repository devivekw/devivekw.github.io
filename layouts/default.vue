<template>
	<div :class="{ dark: $store.state.darkMode }">
		<div class="w-full min-h-screen text-gray-900 bg-gray-50 dark:bg-gray-900 dark:text-gray-50">
			<div class="relative bg-gray-50 dark:bg-gray-900">
				<nav
					class="sticky top-0 z-50 flex items-center justify-between px-12 pb-2 text-xl bg-gray-50 dark:bg-gray-900 lg:px-36 xl:px-48"
